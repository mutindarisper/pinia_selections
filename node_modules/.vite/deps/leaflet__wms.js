...
var require_leaflet_wms = __commonJS({
  "node_modules/leaflet.wms/dist/leaflet.wms.js"(exports, module) {
    (function(factory) {
      ...
      wms.Source = L.Layer.extend({ options: { untiled: true, identify: true }, initialize: function(url, options) {
        ...
        var params = this.getFeatureInfoParams(point, layers), url = this._url + L.Util.getParamString(params, this._url);
        this.showWaiting();
        this.ajax(url, done);
      ...
      wms.Layer = L.Layer.extend({ initialize: function(source, layerName, options) {
        L.setOptions(this, options);
      ...
      wms.tileLayer = L.tileLayer.wms;
      wms.Overlay = L.Layer.extend({ defaultWmsParams: { service: "WMS", request: "GetMap", version: "1.1.1", layers: "", styles: "", format: "image/jpeg", transparent: false }, options: { crs: null, uppercase: false, attribution: "", opacity: 1, isBack: false, minZoom: 0, maxZoom: 18 }, initialize: function(url, options) {
        this._url = url;
        var params = {};
...
// dep:leaflet__wms
var leaflet_wms_default = require_leaflet_wms();
export {
  leaflet_wms_default as default
};
//# sourceMappingURL=leaflet__wms.js.map
