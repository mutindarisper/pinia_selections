...
// node_modules/leaflet-geoserver-request/src/L.Geoserver.js
var require_L_Geoserver = __commonJS({
  "node_modules/leaflet-geoserver-request/src/L.Geoserver.js"() {
      ...
      wmsImage: function() {
        ...
        $.ajax({
          ...
          success: function(data) {
            ...
            maxValue = Math.max(bboxX2 - bboxX1, bboxY2 - bboxY1) / 2;
            var otherLayers = "";
            var otherStyle = "";
            var otherCqlFilter = "";
            ...
            var wmsLayerURL = `${that.baseLayerUrl}/wms?service=WMS&version=1.1.0&request=GetMap&layers=${otherLayers}&styles=${otherStyle}&cql_filter=${otherCqlFilter}&bbox=${(bboxX1 + bboxX2) * 0.5 - maxValue - bufferBbox},${(bboxY1 + bboxY2) * 0.5 - maxValue - bufferBbox},${(bboxX1 + bboxX2) * 0.5 + maxValue + bufferBbox},${(bboxY1 + bboxY2) * 0.5 + maxValue + bufferBbox}&width=${that.options.width}&height=${that.options.height}&srs=EPSG%3A4326&format=image/png`;
...
//# sourceMappingURL=chunk-AZI74FPG.js.map
